...
def post_pic(user_id):
    if request.method == 'POST':
        ...
        if file:
            ...
            line_bot_api.push_message(user_id, ImageSendMessage(original_content_url="https://chanare.com/wp-content/uploads/2017/03/20161214144506-718x404.jpg", preview_image_url=thumb_url + filename))
